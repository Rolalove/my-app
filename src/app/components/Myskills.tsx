...
function Myskills() {
  ...
  return (
    <section id="skills" className="min-h-screen flex flex-col lg:flex-row">
      <main className="flex-grow flex flex-col lg:flex-row mt-28 lg:mt-0">
        <section className="w-full px-4 lg:w-[40%] flex items-center justify-center">
        ...
        <section className="w-full right lg:w-[60%] lg:bg-second_Bc flex items-center justify-center py-8 lg:py-0">
