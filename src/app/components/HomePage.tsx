            ...
            <div className="flex-grow flex flex-col lg:flex-row">
                ...
                <div className="w-full lg:w-[45%] bg-first_Bc text-text_one flex items-center justify-center">
                    <div className="px-4 py-8 lg:py-0 lg:px-10 max-w-2xl">
                        <p className="text-2xl font-semibold ">Hello there, I&apos;m </p>
                        <p className="mt-5 text-xl font-semibold text-second_Bc">KOFOWOROLA SHONUYI</p>
                        <p className="border-2 mt-5 w-fit px-2 py-1 text-xl mb-4 flex items-center rounded-full border-second_Bc">
                            Frontend Developer <span className="ml-2 flex"><Icon icon="fluent-emoji-flat:sparkles" /></span>
                        </p>
                        ...
                        <div className="flex mt-4 items-center gap-x-4">
                            <Link href='https://github.com/Rolalove' target="blank">
                                <Icon className="w-[35px] h-[25px]" icon="mdi:github" />
                            </Link>
                            <Link href='https://www.linkedin.com/in/kofoworola-shonuyi-647835220/' target="blank">
                                <Icon className="w-[35px] h-[25px]" icon="mingcute:linkedin-fill" />
                            </Link>
                            <Link href='https://x.com/rola_dev' target="blank">
                                <Icon className="w-[35px] h-[20px]" icon="prime:twitter" />
                            </Link>
                        </div>
                        <div className="mt-6">
                            <button className='bg-second_Bc text-white px-5 py-2 rounded-md'>View Resume</button>
                        </div>
                    </div>
                </div>

                <div className="w-full right lg:w-[55%] bg-second_Bc flex items-center justify-center py-8 lg:py-0 hidden lg:flex">
                    <Image src='/Rola.webp' width={400} height={400} alt="Kofoworola Shonuyi" loading="lazy" />
                </div>
            </div>
        </section>
    )
